import svgPaths from "./svg-x25ef4gsm8";
...
function HomePageSection1() {
  return (
    <div className="absolute bg-[#0779ff] h-[1117px] left-0 overflow-clip top-0 w-[1728px]" data-name="HomePage-Section1">
      <DhHeader />
...
function HomepageSection1() {
  return (
    <div className="absolute bg-[#0779ff] h-[1117px] left-px overflow-clip top-[2234px] w-[1728px]" data-name="Homepage-Section3">
      <HeaderText1 />
...
function Group11() {
  return (
    <div className="relative size-full" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 113.535 34.5541">
        <g id="Group">
          <path clipRule="evenodd" d={svgPaths.p39869e80} fill="var(--fill-0, #01207D)" fillRule="evenodd" id="a_1_" />
        </g>
      </svg>
    </div>
  );
...
function Group20() {
  return (
    <div className="absolute contents inset-[89.35%_93.93%_0.98%_0.23%]" data-name="Group">
      <div className="absolute flex inset-[89.35%_93.93%_0.98%_0.23%] items-center justify-center">
...
function Group26() {
  return (
    <div className="absolute contents inset-[91.58%_-0.55%_2%_93.69%]" data-name="Group">
      <div className="absolute flex inset-[91.58%_-0.55%_2%_93.69%] items-center justify-center">
...
function SteeringWheel() {
  return (
    <div className="relative size-[109px]" data-name="Steering wheel">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 109 109">
        <g id="Steering wheel">
          <path clipRule="evenodd" d={svgPaths.p36ab3b80} fill="var(--fill-0, #01207D)" fillRule="evenodd" id="Shape" />
        </g>
      </svg>
    </div>
  );
...
function SteeringWheel2() {
  return (
    <div className="relative size-[109px]" data-name="Steering wheel">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 109 109">
        <g id="Steering wheel">
          <path clipRule="evenodd" d={svgPaths.p36ab3b80} fill="var(--fill-0, #B7F9FF)" fillRule="evenodd" id="Shape" />
        </g>
      </svg>
    </div>
  );
...
function BackIcons() {
  return (
    <div className="absolute contents left-[-75.5px] top-[-55px]" data-name="BackIcons">
      <Group2 />
      <Group4 />
      <Group6 />
      <Group8 />
      ...
      <div className="absolute h-[1283.5px] left-[-75.5px] top-[-55px] w-[1841px]">
        <div className="absolute inset-[-1.01%_-0.71%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1867 1309.51">
            <path d={svgPaths.p3a4b3480} id="Vector 10" stroke="var(--stroke-0, #0066DF)" strokeLinecap="round" strokeWidth="26" />
          </svg>
        </div>
      </div>
    </div>
...
function ActivityMarker() {
  return (
    <div className="absolute left-[900px] size-[42px] top-[920px]" data-name="ActivityMarker">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="ActivityMarker">
          <circle cx="21" cy="21" fill="var(--fill-0, #B7F9FF)" id="Ellipse 1" r="21" />
          <circle cx="20.9994" cy="21.0048" fill="var(--fill-0, #01207D)" id="Ellipse 2" r="16.3333" />
          <circle cx="21.0002" cy="20.9987" fill="var(--fill-0, #B7F9FF)" id="Ellipse 3" r="11.6667" />
          <circle cx="20.9995" cy="21.004" fill="var(--fill-0, #01207D)" id="Ellipse 4" r="7" />
        </g>
      </svg>
    </div>
  );
...
function ActivityMarker1() {
  return (
    <div className="absolute left-[669px] size-[42px] top-[402px]" data-name="ActivityMarker">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="ActivityMarker">
          <circle cx="21" cy="21" fill="var(--fill-0, #B7F9FF)" id="Ellipse 1" r="21" />
          <circle cx="20.9994" cy="21.0048" fill="var(--fill-0, #01207D)" id="Ellipse 2" r="16.3333" />
...
function ActivityMarker2() {
  return (
    <div className="absolute left-[1006px] size-[42px] top-[842px]" data-name="ActivityMarker">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="ActivityMarker">
          <circle cx="21" cy="21" fill="var(--fill-0, #B7F9FF)" id="Ellipse 1" r="21" />
          <circle cx="20.9994" cy="21.0048" fill="var(--fill-0, #01207D)" id="Ellipse 2" r="16.3333" />
...
function ActivityMarker3() {
  return (
    <div className="absolute left-[744px] size-[42px] top-[908px]" data-name="ActivityMarker">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 42 42">
        <g id="ActivityMarker">
          <circle cx="21" cy="21" fill="var(--fill-0, #B7F9FF)" id="Ellipse 1" r="21" />
          <circle cx="20.9994" cy="21.0048" fill="var(--fill-0, #01207D)" id="Ellipse 2" r="16.3333" />
...
function HomepageSection2() {
  return (
    <div className="absolute bg-[#0779ff] h-[1117px] left-px overflow-clip top-[3351px] w-[1728px]" data-name="Homepage-Section4">
      <HeaderText2 />
      <BackIcons />
      <div className="absolute h-[523.5px] left-[609px] top-[417px] w-[509.5px]">
        <div className="absolute inset-[-1.05%_-1.08%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 520.5 534.5">
            <path d={svgPaths.p335b54e0} id="Vector 11" stroke="var(--stroke-0, #01207D)" strokeWidth="11" />
          </svg>
        </div>
      </div>
      <CasesName1 />
    ...
    <div className="absolute h-[1427.5px] left-[-75px] top-0 w-[1877px]" data-name="Footer-Backstripes">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1877 1427.5">
        <g id="Footer-Backstripes">
          <mask height="1455" id="mask0_6_189" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="1905" x="-14" y="-14">
          ...
          <g mask="url(#mask0_6_189)">
            <path d={svgPaths.p1c59e80} fill="var(--fill-0, #0779FF)" id="Rectangle 6" />
          </g>
        </g>
      </svg>
    </div>
...
function HomePageFooter() {
  return (
    <div className="absolute bg-[#0779ff] h-[1117px] left-px overflow-clip top-[4454px] w-[1728px]" data-name="HomePage-Footer">
      <Footer />
      <div className="absolute h-[403.5px] left-[-23.5px] top-[-18px] w-[199px]">
        <div className="absolute inset-[-1.94%_-5.21%_-2.69%_-3.59%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 216.519 422.201">
            <path d={svgPaths.pa010800} id="Vector 13" stroke="var(--stroke-0, #0066DF)" strokeWidth="26" />
          </svg>
        </div>
      </div>
      <div className="absolute h-[537px] left-[1221.5px] top-[-27.5px] w-[549.5px]">
        <div className="absolute inset-[-1.09%_-2.19%_-0.91%_-1.97%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 572.386 547.722">
            <path d={svgPaths.p2c073d00} id="Vector 14" stroke="var(--stroke-0, #0066DF)" strokeWidth="26" />
          </svg>
        </div>
      </div>

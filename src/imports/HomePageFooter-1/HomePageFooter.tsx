import svgPaths from "./svg-gkznar1xic";
...
function Contact() {
  return (
    <div className="absolute contents inset-[12.26%_41.24%_81.83%_50.41%]" data-name="Contact">
      <div className="absolute bg-[#b7f9ff] inset-[12.26%_41.24%_81.83%_50.41%] rounded-[25px]" />
      <div className="absolute flex flex-col font-['Futura_Now_Headline',sans-serif] inset-[14.32%_42.69%_84.15%_51.85%] justify-center leading-[0] not-italic text-[#01207d] text-[23px] text-center uppercase">
...
function Contact1() {
  return (
    <div className="absolute inset-[12.26%_50.41%_81.83%_45.78%]" data-name="Contact">
...
function Contact2() {
  return (
    <div className="absolute inset-[12.26%_55.03%_81.83%_41.15%]" data-name="Contact">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66 66">
        <g id="Contact">
          <rect fill="var(--fill-0, #01207D)" height="66" id="Rectangle 3" rx="25" width="66" />
...
function MenuBar() {
  return (
    <div className="absolute contents left-[40.22%] right-[40.28%] top-[123px]" data-name="MenuBar">
      <div className="absolute backdrop-blur-[32px] bg-[rgba(1,32,125,0.42)] inset-[11.01%_40.28%_80.66%_40.22%] rounded-[34px]" data-name="MenuBackground" />
      <Contact />
      <Contact1 />
      <Contact2 />
    </div>

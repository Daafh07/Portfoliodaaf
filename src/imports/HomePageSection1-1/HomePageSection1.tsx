...
function Contact1() {
  return (
    <div className="absolute inset-[90.6%_50.35%_3.49%_45.83%]" data-name="Contact">
...
function Contact2() {
  return (
    <div className="absolute inset-[90.6%_54.98%_3.49%_41.2%]" data-name="Contact">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66 66">
        <g id="Contact">
          <rect fill="var(--fill-0, #01207D)" height="66" id="Rectangle 3" rx="25" width="66" />
...
function MenuBar() {
  return (
    <div className="absolute contents left-[40.28%] right-[40.22%] top-[998px]" data-name="MenuBar">
      <div className="absolute backdrop-blur-[32px] bg-[rgba(1,32,125,0.42)] inset-[89.35%_40.22%_2.33%_40.28%] rounded-[34px]" data-name="MenuBackground" />
      <Contact />
      <Contact1 />
      <Contact2 />
    </div>

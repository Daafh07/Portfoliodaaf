import svgPaths from "./svg-39h6erzy0l";

export default function LoadingScreen() {
  return (
    <div className="bg-[#0779ff] relative size-full overflow-hidden" data-name="LoadingScreen">
      {/* Background decorative curves - centered */}
      <div className="absolute h-[1498px] left-[calc(50%-799.5px)] top-[calc(50%-748.5px)] w-[1652px]">
      ...
      {/* Decorative element 1 - positioned relative to center */}
      <div className="absolute h-[98.5px] left-[calc(50%+330px)] top-[calc(50%-155.5px)] w-[47.5px]">
      ...
      {/* Decorative element 2 - positioned relative to center */}
      <div className="absolute h-[152.5px] left-[calc(50%+108.5px)] top-[calc(50%+93px)] w-[207px]">
      ...
      {/* Decorative element 3 - positioned relative to center */}
      <div className="absolute h-[119px] left-[calc(50%-77px)] top-[calc(50%-67.5px)] w-[114.5px]">
      ...
      {/* Decorative element 4 - positioned relative to center */}
      <div className="absolute h-[76px] left-[calc(50%-299.5px)] top-[calc(50%-141px)] w-[139px]">

...
export function WorkPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#0779ff] overflow-y-auto overflow-x-hidden">
      ...
      <Link
        to="/"
        className="fixed top-8 right-8 z-[60] bg-[#01207d] text-[#b7f9ff] w-[60px] h-[60px] rounded-full flex items-center justify-center font-['Futura_Now_Headline:Cn_XBold',sans-serif] text-[32px] hover:bg-[#b7f9ff] hover:text-[#01207d] transition-colors"
      >
        ×
      </Link>
